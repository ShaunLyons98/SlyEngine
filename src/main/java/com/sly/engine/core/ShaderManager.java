...
public class ShaderManager {
    ...
    public ShaderManager() throws Exception {
        ...
        if(programID == 0)
            throw new Exception("ERROR: Failed to create shader!");
    ...
    public void createUniform(String uniformName) throws Exception {
        ...
        if(uniformLocation < 0)
            throw new Exception("ERROR: Unable to find uniform! Details: " + uniformName);
    ...
    public void link() throws Exception {
        ...
        if(GL20.glGetProgrami(programID, GL20.GL_VALIDATE_STATUS) == 0)
            throw new Exception("Error: Unable to validate shader code! " + GL20.glGetProgramInfoLog(programID, 1024));
    }
